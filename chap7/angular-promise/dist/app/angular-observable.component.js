...
var AngularObservableAppComponent = (function () {
    function AngularObservableAppComponent(IMDBAPI) {
        ...
        this.error = false;
        this.finished = false;
        this.IMDBAPI.fecthOneById(1).then(function (value) {
            _this.movies.push(value);
            console.log("Component", value);
        }, function (error) { return _this.error = true; });
        this.IMDBAPI.fetchByField(movie_1.MovieFields.release_year, 2015).then(function (value) {
            _this.movies = value;
            console.log("Component", value);
        }, function (error) { return _this.error = true; });
        this.IMDBAPI.byField(movie_1.MovieFields.release_year, 2015)
            .or(movie_1.MovieFields.release_year, 2014)
            .or(movie_1.MovieFields.phase, "Phase Two")
            .fetch()
            .then(function (value) {
            _this.movies = value;
            console.log("Component", value);
